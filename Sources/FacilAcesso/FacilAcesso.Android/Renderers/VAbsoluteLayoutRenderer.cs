...
[assembly: ExportRenderer(typeof(FacilAcesso.VAbsoluteLayout), typeof(FacilAcesso.Droid.VAbsoluteLayoutRenderer))]
namespace FacilAcesso.Droid
{
    public class VAbsoluteLayoutRenderer : VisualElementRenderer<VAbsoluteLayout>
    {
        private bool _panStarted = false;
        private bool _pinchStarted = false;
        private double _originDistance;

        public VAbsoluteLayoutRenderer(Context ctx) : base(ctx)
        {

        }

        protected override void OnElementChanged(ElementChangedEventArgs<VAbsoluteLayout> e)
        {
        ...
        public override bool OnTouchEvent(MotionEvent e)
        {
            var totalX = e.GetX();
            var totalY = e.GetY();
            var element = Element as VAbsoluteLayout;
        ...
        private void EndPan(VAbsoluteLayout element, float x, float y)
        {
